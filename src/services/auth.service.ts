...
import {
  ...
  OtpVerificationResponseInterface,
  PostLoginInterface,
  RegisterInterface,
  RegisterResponseInterface,
  ResendOtpVerificationInterface,
  ResendOtpVerificationResponseInterface,
...
): Promise<OtpVerificationResponseInterface> => {
  const { data } = await axiosInstance.post("/auth/verify/otp", payload);
  return data.data;
};

// Resend OTP Verification
export const resendOtpVerificationService = async (
  payload: ResendOtpVerificationInterface,
): Promise<ResendOtpVerificationResponseInterface> => {
  const { data } = await axiosInstance.post("/auth/generate/otp", payload);
  return data.data;
};

// Forgot password
export const forgotPasswordEmailService = async (
  payload: ForgotPasswordEmailInterface,
): Promise<ResendOtpVerificationResponseInterface> => {
  const { data } = await axiosInstance.post("/auth/password/otp", payload);
  return data.data;
};

export const forgotPasswordOtpVerificationService = async (
  payload: OtpVerificationInterface,
