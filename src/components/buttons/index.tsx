...
export const Button = ({
  ...
  return (
    <button
      ...
      className={`flex  cursor-pointer font-grotesk-semi-bold pt-2 my-1 pb-3 px-12 items-center rounded-full justify-center ${fullWidth && "w-full"} ${type === "bgGreen" ? "bg-[#BEDD3A]" : type === "bgBlack" ? "bg-bayfi-black-500 text-white" : "bg-white text-bayfi-black-500"}`}
    ...
    >
      ...
      </div> : <ButtonSpinner spinnerColor={type} /> }
